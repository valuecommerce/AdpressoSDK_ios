...
class MasterViewController: UITableViewController {
  ...
  let menuItems = [
                  MenuItem(name: "Banner View (Interface Builder)", className: "BannerIBViewController"),
                  MenuItem(name: "Banner View (Code)",              className: "BannerCodeViewController"),
                  MenuItem(name: "Banner in Table",                 className: "TableViewController"),
                  MenuItem(name: "Interstitial Ad",                 className: "InterstitialViewController")
                ]
